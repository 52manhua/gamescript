        ...
        */     
        ...
        if(oSession.fullUrl.IndexOf("start") != -1 && oSession.fullUrl.IndexOf("pvp") == -1 && modEnable=="yes") {
            ...
            */
            ...
            str=regex.Replace(str, "[20071,20063,49,53,31963,31663,31663,31663,31683,31683,41,31693,339,10023,20079,20023,20033,20004,20063,31693,397,398,60031,31983,43,489],\"");           
           
            
            //盾白雪
            var regex=new Regex("\\[40022,20073,38982,10052,31683,31663,31683,31663,31683\\],\"");
            str=regex.Replace(str, "[20071,40022,20073,38982,10052,31683,31663,31683,31663,31683,31693,339,10023,20079,20023,20033,20004,20063,31693,397,398,60031,31983],\"");           
            ...
            str=regex.Replace(str, "[20071,451,57,171,31693,339,10023,20079,20023,20033,20004,20063,31693,397,398,10052,31983,43,489],\"");           

            //妖精王混沌V2
            var regex=new Regex("\\[451,57,31683,31383,31363,31683,31683,31683,31663,31663,171,135,65,10031\\],\"");
            str=regex.Replace(str, "[20071,451,57,31683,31383,31363,31683,31683,31683,31663,31663,171,135,65,10031,31693,339,10023,20079,20023,20033,20004,20063,31693,397,398,10052,31983,43,489],\"");           
            
            //魔王
            var regex=new Regex("\\[31689,383,31681\\],\"");
            str=regex.Replace(str, "[20071,31689,383,31681,31693,339,20079,10023,20023,20033,20004,20063,31693,397,398,10052,31983,43,489],\"");                       
            
            //dull alice skill
            var regex=new Regex("\\[103,31658,51\\],\"");
            str=regex.Replace(str, "[20071,103,51,339,20004,20079,10023,31658,397,398,31992,10052,31983,43,489],\""); 
            
            //jack
            var regex=new Regex("\\[173,181,53,31963,31683,31683,31683,31663,1343\\],\"");
            str=regex.Replace(str, "[20071,173,181,53,31963,31683,31683,31683,31663,1343,51,339,20004,20079,10023,31658,397,398,31992,10052,31983,43,489],\"");             
            ...
            str=regex.Replace(str, "[20073,154,20071,51,339,20004,20079,10023,31658,397,398,31992,10052,31983,43,489],\"");
