        ...
        */     
        ...
        if(oSession.fullUrl.IndexOf("start") != -1 && oSession.fullUrl.IndexOf("pvp") == -1 && modEnable=="yes") {
            ...
            */
            ...
            str=regex.Replace(str, "[451,57,171,31693,339,10023,20079,20023,20033,20004,20063,31693,397,398,10052,31983,43,489,40010,60031,20043],\"");           
            
            //魔王
            var regex=new Regex("\\[31689,383,31681\\],\"");
            str=regex.Replace(str, "[31689,383,31681,31693,339,20079,10023,20023,20033,20004,20063,31693,397,398,10052,31983,43,489,38982,40010,60031,20043],\"");                       
            ...
            str=regex.Replace(str, "[20071,451,57,31683,31383,31363,31683,31683,31683,31663,31663,171,135,65,10031,31693,339,10023,20079,20023,20033,20004,20063,31693,397,398,10052,31983,43,489,38982,20043],\"");
            ...
            str=regex.Replace(str, "[40123,173,40131,31683,20073,31683,31683,31683,31683,31683,171,135,65,10031,31693,339,10023,20079,20023,20033,20004,20063,31693,397,398,10052,31983,43,489],\"");
            
            //混乱灰20073,389,20071
            var regex=new Regex("\\[20073,389,20071\\],\"");
            str=regex.Replace(str, "[20073,389,20071,171,135,65,10031,31693,339,10023,20079,20023,20033,20004,20063,31693,397,398,10052,31983,43,489],\"");            
