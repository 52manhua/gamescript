        ...
        */     
        ...
        if(oSession.fullUrl.IndexOf("start") != -1 && oSession.fullUrl.IndexOf("pvp") == -1 && modEnable=="yes") {
            ...
            */
            ...
            //gn光 239661
            //冰大 31689 火大 31693 光大 31663
            
            //通用技能串 20023,20033,20004,20063,31693,397,398,10052,31983,43,
            //重串 31689,31689,31689,31689,31689,31689,31983,31983,31983,31683,20073,31689,31689,31689,31689,31689,31689,31983,31983,31983,31683,20073,20073,20073,20073,
            var havfire = "31693,31693,31693,31693,31693,31693,31983,31983,31983,31683,20073,31693,31693,31693,31693,31693,31693,31983,31983,31983,31683,20073,20073,20073,20073,"
            var havice = "31689,31689,31689,31689,31689,31689,31983,31983,31983,31683,20073,31689,31689,31689,31689,31689,31689,31983,31983,31983,31683,20073,20073,20073,20073,"
            var havlight = "31663,31663,31663,31663,31663,31663,31983,31983,31983,31683,20073,31663,31663,31663,31663,31663,31663,31983,31983,31983,31683,20073,20073,20073,20073,"
            
            var st= havlight + "533,20073,31683,20023,20033,20004,20063,31693,397,398,10052,31983,43,"
            //31983
            ...
            //princess
            var regex=new Regex("\\[20063,49,53,31963,31663,31663,31663,31683,31683,41\\],\"");
            str=regex.Replace(str, "[20063,49,53,31963,31663,31663,31663,31683,31683,41,31693,339,10023,20079,20023,20033,20004,20063,31693,397,398,60031,31983,43,489],\"");           
           
            //白玫瑰
            var regex=new Regex("\\[40002,499,50043,332,31683,31683,31663,31663,31663\\],\"");
            str=regex.Replace(str, "[40002,499,50043,332,31683,31683,31663,31663,31663"+ st +"20043],\"");           
          
            //杖朱丽叶
            var regex=new Regex("\\[343,373,20004,31993,31982,31683,20043,20023,20033\\],\"");
            str=regex.Replace(str, "[343,373,20004,31993,31982,31683,20043,20023,20033"+ st +"20043],\"");                       
            
            //盾白雪
            var regex=new Regex("\\[40022,20073,38982,10052,31683,31663,31683,31663,31683\\],\"");
            str=regex.Replace(str, "[40022,20073,38982,10052,31683,31663,31683,31663,31683,31693,339,10023,20079,20023,20033,20004,20063,31693,397,398,60031,31983,20043],\"");           
            ...
            str=regex.Replace(str, "[451,57,171,31693,339,10023,20079,"+ st +"489,40010,60031,20043],\"");           
            
            //魔王
            var regex=new Regex("\\[31689,383,31681\\],\"");
            str=regex.Replace(str, "[31689,383,31681,31693,339,20079,10023,"+ st +"489,38982,40010,60031,20043],\"");                       
            
            //弓造物
            var regex=new Regex("\\[133,239691,31691\\],\"");
            str=regex.Replace(str, "[133,239691,31691,31693,339,20079,10023,"+ st +"489,38982,40010,60031,20043],\"");                                 
            
            //美女杖
            var regex=new Regex("\\[40002,279\\],\"");
            str=regex.Replace(str, "[40002,279,31693,339,20079,10023,"+ st +"489,38982,40010,60031,20043],\"");                  
            
            //dull alice skill
            var regex=new Regex("\\[103,31658,51\\],\"");
            str=regex.Replace(str, "[103,51,339,20004,20079,10023,31658,397,398,31992,10052,31983,43,489,38982,20043],\""); 
            
            //jack
            var regex=new Regex("\\[173,181,53,31963,31683,31683,31683,31663,1343\\],\"");
            str=regex.Replace(str, "[173,181,53,31963,31683,31683,31683,31663,1343,51,339,20004,20079,10023,31658,397,398,31992,10052,31983,43,489],\"");             
            ...
            //白发骑士姬 20073,20071
            var regex=new Regex("\\[20073,154,20071\\],\"");
            str=regex.Replace(str, "[20073,154,20071,51,339,20004,20079,10023,31658,397,398,31992,10052,31983,43,489,40010,60031,20043],\"");
            ...
            //拳王40123,173,40131,31683,20073,31683,31683,31683,31683,31683
            var regex=new Regex("\\[40123,173,40131,31683,20073,31683,31683,31683,31683,31683\\],\"");
            str=regex.Replace(str, "[40123,173,40131,31683,20073,31683,31683,31683,31683,31683,171,135,65,10031,31693,339,10023,20079,"+ st +"489],\"");
            
            //混乱灰20073,389,20071
            var regex=new Regex("\\[20073,389,20071\\],\"");
            str=regex.Replace(str, "[20073,389,20071,171,135,65,10031,31693,339,10023,20079,"+ st +"489],\"");            
           
            //239661[40203,239651] ssby
            var regex=new Regex("\\[40203,239651\\],\"");
            str=regex.Replace(str, "[40203,239651,239661,38982,20043],\"");            
           
            //40033,353,38981,10051
            var regex=new Regex("\\[40033,353,38981,10051\\],\"");
            str=regex.Replace(str, "[40033,353,38981,38982,10051],\"");     
        ...
        if(oSession.fullUrl.IndexOf("pvp/battle/start") != -1){
            ...
            str=regex.Replace(str, "339,533,20004,31663,103,31663,93,10002,31663,31663,31663,31663,31663,65535");
            
            //黑白天鹅
            var regex=new Regex("\\[43,36689,243,20043,20023,20033,31693,20063,65535\\],\"");
            str=regex.Replace(str, "[339,533,43,36689,243,20043,20023,20033,31693,20063,65535,20004,10023],\""); 
            ...
            //强化自己
            var regex=new Regex("\"my_party_detail\":\{\"main_calc_union_list\":\\[\{\"slot_id\":1,\"union\":\{\"m_leading_character_id\":5,\"front_calc_character\":\{\"d_character_serial\":65,\"m_character_id\":5400102,\"level\":90,\"level_limit_break_count\":4,\"hp\":6192,\"attack\":1507,\"defence\":9,\"clear_ordeal_flag\":3,\"m_weapon_id\":490007,\"town_effect_value\":2650,\"visual_m_character_id\":5400102,\"current_hp\":9380,\"battle_ai_type\":null,\"equip_m_dress_id\":null,");
            str=regex.Replace(str, "\"my_party_detail\":{\"main_calc_union_list\":[{\"slot_id\":1,\"union\":{\"m_leading_character_id\":5,\"front_calc_character\":{\"d_character_serial\":65,\"m_character_id\":5400102,\"level\":90,\"level_limit_break_count\":4,\"hp\":9992,\"attack\":1507,\"defence\":99999,\"clear_ordeal_flag\":3,\"m_weapon_id\":490007,\"town_effect_value\":2650,\"visual_m_character_id\":5400102,\"current_hp\":9380,\"battle_ai_type\":null,\"equip_m_dress_id\":null,");            
            //var regex=new Regex("\"defence\":1395,");
            //str=regex.Replace(str, "\"defence\":"+ '9999' +",");     
