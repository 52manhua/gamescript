        ...
        */     
        ...
        if(oSession.fullUrl.IndexOf("start") != -1 && oSession.fullUrl.IndexOf("pvp") == -1 && modEnable=="yes") {
            ...
            */
            ...
            var st= havfire + "533,20073,31683,20023,20033,20004,20063,31693,397,398,10052,31983,43,"
            //31983
        ...
        if(oSession.fullUrl.IndexOf("pvp/battle/start") != -1){
            ...
            //血MM
            var regex=new Regex("\\[123,63,322,31993,31972,31992,20023,31992,31972,65535\\],\"");
            str=regex.Replace(str, "[123,63,31993,31972,31992,31972,6553531693,339,20079,20023,20033,20004,20063,31693],\"");
            ...
            str=regex.Replace(str, "[43,36689,243,20043,20023,20033,31693,20063,65535,20004,10023],\""); 
